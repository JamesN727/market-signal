  ...
  return (
    <div className="Container">
      ...
      <div className="daily-score-section">
        <h3>Today's Market Sentiment Score</h3>
        {dailyScore ? (
          <div>
            {/* Display the number safely */}
            <h3
              style={{ color: dailyScore.average_score > 0 ? "green" : "red" }}
            >
              {dailyScore.average_score.toFixed(2)}
            </h3>
            <p>Based on {dailyScore.article_count} articles</p>
          </div>
        ) : (
      ...
      {/*Error && means only show if error is not empty*/}
      {result && (
